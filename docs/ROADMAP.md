...
- **Competing harnesses**: Goose + Traefik (Abhimanyu), mehul mathur's harness, shrinivasan's personal harness, others. Ark's differentiator is the control layer on top -- compute orchestration + central knowledge/cost/router -- not a better chat loop.
