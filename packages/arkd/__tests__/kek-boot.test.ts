...
describe("arkd boot -- KEK", () => {
  it(
    "boots with the default stub KEK installed by forTestAsync",
    async () => {
  ...
  it(
    "disposes the SecureBuffer on shutdown",
    async () => {
  ...
  it(
    "fails to boot when config.kek is missing and no stub provided",
    async () => {
